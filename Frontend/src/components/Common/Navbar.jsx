          ...
          {!user ? (
            ...
            <>
              ...
              <button
                ...
                className="rounded-xl px-4 py-3 text-left text-base font-medium text-red-400 transition-colors hover:bg-red-500/10"
              >
                Logout
              </button>
            </>
